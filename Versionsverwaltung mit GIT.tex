...
\section{Tools}
\subsection{gitk}
\begin{frame}\frametitle{Repository Tool: gitk}
\begin{block}{gitk}
...
\subsection{git-gui}
\begin{frame}\frametitle{Commit Tool: git-gui}
\begin{block}{gitk}
...
\caption{\textit{git gui}: einfach, übersichtlich und immer da!}
\end{figure}
\end{frame}
...
\section{Befehle}
\begin{frame}\frametitle{Befehle}
...
\begin{block} {Remotes}
Unter einem Remote versteht man eine entfernte Quelle. Der \lstinline|git remote| Befehl dient zum Verwalten der Remotes:
\lstinputlisting{remote.txt}

oder ausführlicher mit:
\lstinputlisting{remote2.txt}

einen neuen Alias auf einen entfernten Remote hinzufügen:
\lstinputlisting{remote3.txt}
